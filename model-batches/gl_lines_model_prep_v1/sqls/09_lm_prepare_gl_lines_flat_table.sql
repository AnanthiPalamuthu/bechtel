...
where
unix_timestamp(${load.period.column.name},'${load.period.time.format}') >= unix_timestamp('Dec-15','${load.period.time.format}')
and
unix_timestamp(${load.period.column.name},'${load.period.time.format}') <= unix_timestamp('Jul-16','${load.period.time.format}')
